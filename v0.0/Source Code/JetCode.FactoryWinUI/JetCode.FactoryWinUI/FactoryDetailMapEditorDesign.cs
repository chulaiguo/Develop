...
{
    public class FactoryDetailMapEditorDesign : FactoryBase
    {
        public FactoryDetailMapEditorDesign(MappingSchema mappingSchema, ObjectSchema objectSchema)
        ...
        private void WriteFieldDetail(StringWriter writer, FieldSchemaCollection list)
        {
            ...
            foreach (FieldSchema item in list)
            {
                ...
                if (dotnetType == typeof(bool))
                {
                    ...
                    writer.WriteLine("\t\t\tthis.chk{0}.ReadOnly = {1};", item.Alias, item.IsJoined ? "true" : "false");
                ...
                else if (dotnetType == typeof(DateTime))
                {
                    ...
                    writer.WriteLine("\t\t\tthis.date{0}.ReadOnly = {1};", item.Alias, item.IsJoined ? "true" : "false");
                ...
                else if (dotnetType == typeof(string))
                {
                    ...
                    writer.WriteLine("\t\t\tthis.txt{0}.ReadOnly = {1};", item.Alias, item.IsJoined ? "true" : "false");
