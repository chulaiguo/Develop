...
{
    public class FactoryFacadeServiceViewObj : FactoryBase
    {
        public FactoryFacadeServiceViewObj(MappingSchema mappingSchema)
            : base(mappingSchema)
        {
        }
        ...
        protected override void WriteUsing(StringWriter writer)
        {
            ...
            writer.WriteLine("using {0}.FacadeServiceWrapper;", base.ProjectName);
