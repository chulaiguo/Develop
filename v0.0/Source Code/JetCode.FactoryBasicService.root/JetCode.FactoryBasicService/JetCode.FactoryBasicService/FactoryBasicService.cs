...
{
    public class FactoryBasicService : FactoryBase
    {
        public FactoryBasicService(MappingSchema mappingSchema)
            : base(mappingSchema)
        {
        }
        ...
        {
            writer.WriteLine("namespace {0}.BasicService", base.ProjectName);
            writer.WriteLine("{");
            writer.WriteLine("\tpublic class BasicServiceFactory: MarshalByRefObject, IBasicServiceFactory");
            writer.WriteLine("\t{");
        }
